...
const [cargo_por_uso_dt1_cop_kwh, setCargo_Por_Uso_Dt1_Cop_Kwh] = useState("No Esta1");
const [cargo_por_uso_dt2_cop_kwh, setCargo_Por_Uso_Dt2_Cop_Kwh] = useState("No Esta");
const [cargo_por_uso_dt3_cop_kwh, setCargo_Por_Uso_Dt3_Cop_Kwh] = useState("No Esta");
const [cargo_de_inversion_cdi1_cop_kwh, setCargo_De_Inversion_Cdi1_Cop_Kwh] = useState("No Esta");
const [cargo_por_aom_cda1_cop_kwh, setCargo_Por_Aom_Cda1_Cop_Kwh] = useState("No Esta");
const [cargo_nivel_de_tension_cd2_cop_kwh, setCargo_Nivel_De_Tension_Cd2_Cop_Kwh] = useState("No Esta");
const [cargo_nivel_de_tension_cd3_cop_kwh, setCargo_Nivel_De_Tension_Cd3_Cop_Kwh] = useState("No Esta");
const [cargo_nivel_de_tension_cd3_2_cop_kwh, setCargo_Nivel_De_Tension_Cd3_2_Cop_Kwh] = useState("No Esta");
const [cargo_nivel_de_tension_cd4_cop_kwh, setCargo_Nivel_De_Tension_Cd4_Cop_Kwh] = useState("No Esta");
const [cargo_por_incentivos_dtcs_cop_kwh, setCargo_Por_Incentivos_Dtcs_Cop_Kwh] = useState("No Esta");
const [fraccion_dtcs_cop_kwh, setFraccion_Dtcs_Cop_Kwh] = useState("No Esta");
const [ia1, setIa1] = useState("No Esta");const [ia2, setIa2] = useState("No Esta");
const [ia3, setIa3] = useState("No Esta");const [iaa1_cop, setIaa1_Cop] = useState("No Esta");const [iaa2_cop, setIaa2_Cop] = useState("No Esta");const [iaa3_cop, setIaa3_Cop] = useState("No Esta");const [irm1_cop, setIrm1_Cop] = useState("No Esta");const [irm2_cop, setIrm2_Cop] = useState("No Esta");const [irm3_cop, setIrm3_Cop] = useState("No Esta");const [fm, setFm] = useState("No Esta");const [iaaom1_cop, setIaaom1_Cop] = useState("No Esta");const [iaaom2_cop, setIaaom2_Cop] = useState("No Esta");const [iaaom3_cop, setIaaom3_Cop] = useState("No Esta");const [aomni1_cop, setAomni1_Cop] = useState("No Esta");const [aomni2_cop, setAomni2_Cop] = useState("No Esta");const [aomni3_cop, setAomni3_Cop] = useState("No Esta");const [ima_n1, setIma_N1] = useState("No Esta");const [ima_n2, setIma_N2] = useState("No Esta");const [ima_n3, setIma_N3] = useState("No Esta");const [imn_n1, setImn_N1] = useState("No Esta");const [imn_n2, setImn_N2] = useState("No Esta");const [imn_n3, setImn_N3] = useState("No Esta");const [aim_n1, setAim_N1] = useState("No Esta");const [aim_n2, setAim_N2] = useState("No Esta");const [aim_n3, setAim_N3] = useState("No Esta");const [naim_n1, setNaim_N1] = useState("No Esta");const [naim_n2, setNaim_N2] = useState("No Esta");const [naim_n3, setNaim_N3] = useState("No Esta");const [fraccion_aim_n1_inversion, setFraccion_Aim_N1_Inversion] = useState("No Esta");const [fraccion_aim_n1_aom, setFraccion_Aim_N1_Aom] = useState("No Esta");const [bra1_cop, setBra1_Cop] = useState("No Esta");const [bra2_cop, setBra2_Cop] = useState("No Esta");const [bra3_cop, setBra3_Cop] = useState("No Esta");const [brae1_cop, setBrae1_Cop] = useState("No Esta");const [brae2_cop, setBrae2_Cop] = useState("No Esta");const [brae3_cop, setBrae3_Cop] = useState("No Esta");const [braen1_cop, setBraen1_Cop] = useState("No Esta");const [braen2_cop, setBraen2_Cop] = useState("No Esta");const [braen3_cop, setBraen3_Cop] = useState("No Esta");const [rc1_cop, setRc1_Cop] = useState("No Esta");const [rc2_cop, setRc2_Cop] = useState("No Esta");const [rc3_cop, setRc3_Cop] = useState("No Esta");const [cdi_aj_1_cop2007_kwh, setCdi_Aj_1_Cop2007_Kwh] = useState("No Esta");const [cd_aj_2_cop2007_kwh, setCd_Aj_2_Cop2007_Kwh] = useState("No Esta");const [cd_aj_3_cop2007_kwh, setCd_Aj_3_Cop2007_Kwh] = useState("No Esta");const [cdm_aj_1_cop2007_kwh, setCdm_Aj_1_Cop2007_Kwh] = useState("No Esta");const [iapa1, setIapa1] = useState("No Esta");const [iapa2, setIapa2] = useState("No Esta");const [iapa3, setIapa3] = useState("No Esta");const [iapa1_tant, setIapa1_Tant] = useState("No Esta");const [iapa2_tant, setIapa2_Tant] = useState("No Esta");const [iapa3_tant, setIapa3_Tant] = useState("No Esta");const [oi1_cop, setOi1_Cop] = useState("No Esta");const [oj2_cop, setOj2_Cop] = useState("No Esta");const [oj3_cop, setOj3_Cop] = useState("No Esta");const [irespaldo1_cop, setIrespaldo1_Cop] = useState("No Esta");const [irespaldo2_cop, setIrespaldo2_Cop] = useState("No Esta");const [irespaldo3_cop, setIrespaldo3_Cop] = useState("No Esta");const [imunts1_cop, setImunts1_Cop] = useState("No Esta");const [imunts2_cop, setImunts2_Cop] = useState("No Esta");const [imunts3_cop, setImunts3_Cop] = useState("No Esta");const [ireactiva1_cop, setIreactiva1_Cop] = useState("No Esta");const [ireactiva2_cop, setIreactiva2_Cop] = useState("No Esta");const [ireactiva3_cop, setIreactiva3_Cop] = useState("No Esta");const [aombase1, setAombase1] = useState("No Esta");const [aombase2, setAombase2] = useState("No Esta");const [aombase3, setAombase3] = useState("No Esta");const [brae1_tant_cop, setBrae1_Tant_Cop] = useState("No Esta");const [brae2_tant_cop, setBrae2_Tant_Cop] = useState("No Esta");const [brae3_tant_cop, setBrae3_Tant_Cop] = useState("No Esta");const [deltabraenj_1_cop, setDeltabraenj_1_Cop] = useState(0);const [deltabraenj_2_cop, setDeltabraenj_2_Cop] = useState(0);const [deltabraenj_3_cop, setDeltabraenj_3_Cop] = useState(0);const [deltaingj_1_cop, setDeltaingj_1_Cop] = useState("No Esta");const [deltaingj_2_cop, setDeltaingj_2_Cop] = useState("No Esta");const [deltaingj_3_cop, setDeltaingj_3_Cop] = useState("No Esta");const [brt1_cop, setBrt1_Cop] = useState("No Esta");const [brt2_cop, setBrt2_Cop] = useState("No Esta");const [brt3_cop, setBrt3_Cop] = useState("No Esta");const [rcbia1_cop, setRcbia1_Cop] = useState("No Esta");const [rcbia2_cop, setRcbia2_Cop] = useState("No Esta");const [rcbia3_cop, setRcbia3_Cop] = useState("No Esta");const [rcna1_cop, setRcna1_Cop] = useState("No Esta");const [rcna2_cop, setRcna2_Cop] = useState("No Esta");const [rcna3_cop, setRcna3_Cop] = useState("No Esta");const [rcnafo1_cop, setRcnafo1_Cop] = useState("No Esta");const [rcnafo2_cop, setRcnafo2_Cop] = useState("No Esta");const [rcnafo3_cop, setRcnafo3_Cop] = useState("No Esta");const [inve1_cop, setInve1_Cop] = useState("No Esta");const [inve2_cop, setInve2_Cop] = useState("No Esta");const [inve3_cop, setInve3_Cop] = useState("No Esta");const [inva1_cop, setInva1_Cop] = useState("No Esta");const [inva2_cop, setInva2_Cop] = useState("No Esta");const [inva3_cop, setInva3_Cop] = useState("No Esta");const [inva1_tant_cop, setInva1_Tant_Cop] = useState("No Esta");const [inva2_tant_cop, setInva2_Tant_Cop] = useState("No Esta");const [inva3_tant_cop, setInva3_Tant_Cop] = useState("No Esta");const [invr1_maximo_tant_cop, setInvr1_Máximo_Tant_Cop] = useState("No Esta");const [invr2_maximo_tant_cop, setInvr2_Máximo_Tant_Cop] = useState("No Esta");const [invr3_maximo_tant_cop, setInvr3_Máximo_Tant_Cop] = useState("No Esta");const [invr1_delta_cop, setInvr1_Delta_Cop] = useState("No Esta");const [invr2_delta_cop, setInvr2_Delta_Cop] = useState("No Esta");const [invr3_delta_cop, setInvr3_Delta_Cop] = useState("No Esta");const [invr1_tant_cop, setInvr1_Tant_Cop] = useState("No Esta");const [invr2_tant_cop, setInvr2_Tant_Cop] = useState("No Esta");const [invr3_tant_cop, setInvr3_Tant_Cop] = useState("No Esta");const [pr1, setPr1] = useState("No Esta");const [pr2, setPr2] = useState("No Esta");const [pr3, setPr3] = useState("No Esta");const [pj_1, setPj_1] = useState("No Esta");const [pj_2, setPj_2] = useState("No Esta");const [pj_3, setPj_3] = useState("No Esta");const [pj_1_creg097, setPj_1_Creg097] = useState("No Esta");const [pj_2_creg097, setPj_2_Creg097] = useState("No Esta");const [pj_3_creg097, setPj_3_Creg097] = useState("No Esta");const [acumulado_eej1_kwh, setAcumulado_Eej1_Kwh] = useState("No Esta");const [acumulado_eej2_kwh, setAcumulado_Eej2_Kwh] = useState("No Esta");const [acumulado_eej3_kwh, setAcumulado_Eej3_Kwh] = useState("No Esta");const [acumulado_fej3_2_kwh, setAcumulado_Fej3_2_Kwh] = useState("No Esta");const [euj_2_creg097_kwh, setEuj_2_Creg097_Kwh] = useState("No Esta");const [fej3_2_creg097_kwh, setFej3_2_Creg097_Kwh] = useState("No Esta");const [ic_saidi_cop, setIc_Saidi_Cop] = useState("No Esta");const [ic_saifi_cop, setIc_Saifi_Cop] = useState("No Esta");const [conp_cop, setConp_Cop] = useState("No Esta");const [vcdij_tant_kwh, setVcdij_Tant_Kwh] = useState("No Esta");const [vcinj_tant_kwh, setVcinj_Tant_Kwh] = useState("No Esta");const [vacpiec1, setVacpiec1] = useState("No Esta");const [vacpiec2, setVacpiec2] = useState("No Esta");const [vacpiec3, setVacpiec3] = useState("No Esta");const [vacni1, setVacni1] = useState("No Esta");const [vacni2, setVacni2] = useState("No Esta");const [vacni3, setVacni3] = useState("No Esta");const [r_tasa_retorno_actividad_distribucion, setR_Tasa_Retorno_Actividad_Distribucion] = useState("No Esta");const [famb, setFamb] = useState("No Esta");const [css1_cop, setCss1_Cop] = useState("No Esta");const [css2_cop, setCss2_Cop] = useState("No Esta");const [css3_cop, setCss3_Cop] = useState("No Esta");const [dismining1_cop, setDismining1_Cop] = useState("No Esta");const [dismining2_cop, setDismining2_Cop] = useState("No Esta");const [dismining3_cop, setDismining3_Cop] = useState("No Esta");
...
if (lines[i][0] ==="Cargo nivel de tensión CD4 con DeltaCD4 (COP/kWh)"){setCargo_Nivel_De_Tension_Cd4_Cop_Kwh(lines[i][1])};
...
if (lines[i][0] ==="IA1"){setIa1(lines[i][1])};
if (lines[i][0] ==="IA2"){setIa2(lines[i][1])};
if (lines[i][0] ==="IA3"){setIa3(lines[i][1])};
if (lines[i][0] ==="IAA1 (COP)"){setIaa1_Cop(lines[i][1])};
...
try {
    ...
    console.log(creador,empresa_id,parseFloat((fileNames[0].substr(26,4))),parseFloat((fileNames[0].substr(30,2))),
    cargo_por_uso_dt1_cop_kwh,cargo_por_uso_dt2_cop_kwh,cargo_por_uso_dt3_cop_kwh,cargo_de_inversion_cdi1_cop_kwh,
    cargo_por_aom_cda1_cop_kwh,cargo_nivel_de_tension_cd2_cop_kwh,cargo_nivel_de_tension_cd3_cop_kwh,
    cargo_nivel_de_tension_cd3_2_cop_kwh,cargo_nivel_de_tension_cd4_cop_kwh,cargo_por_incentivos_dtcs_cop_kwh,
    fraccion_dtcs_cop_kwh,ia1,ia2,ia3,iaa1_cop,iaa2_cop,iaa3_cop,irm1_cop,irm2_cop,irm3_cop,fm,iaaom1_cop,
    iaaom2_cop,iaaom3_cop,aomni1_cop,aomni2_cop,aomni3_cop,ima_n1,ima_n2,ima_n3,imn_n1,imn_n2,imn_n3,aim_n1,aim_n2,aim_n3,
    naim_n1,naim_n2,naim_n3,fraccion_aim_n1_inversion,fraccion_aim_n1_aom,bra1_cop,bra2_cop,bra3_cop,brae1_cop,brae2_cop,
    brae3_cop,braen1_cop,braen2_cop,braen3_cop,rc1_cop,rc2_cop,rc3_cop,cdi_aj_1_cop2007_kwh,cd_aj_2_cop2007_kwh,cd_aj_3_cop2007_kwh,
    cdm_aj_1_cop2007_kwh,iapa1,iapa2,iapa3,iapa1_tant,iapa2_tant,iapa3_tant,oi1_cop,oj2_cop,oj3_cop,irespaldo1_cop,irespaldo2_cop,
    irespaldo3_cop,imunts1_cop,imunts2_cop,imunts3_cop,ireactiva1_cop,ireactiva2_cop,ireactiva3_cop,aombase1,aombase2,aombase3,
    brae1_tant_cop,brae2_tant_cop,brae3_tant_cop,deltabraenj_1_cop,deltabraenj_2_cop,deltabraenj_3_cop,deltaingj_1_cop,
    deltaingj_2_cop,deltaingj_3_cop,brt1_cop,brt2_cop,brt3_cop,rcbia1_cop,rcbia2_cop,rcbia3_cop,rcna1_cop,rcna2_cop,rcna3_cop,
    rcnafo1_cop,rcnafo2_cop,rcnafo3_cop,inve1_cop,inve2_cop,inve3_cop,inva1_cop,inva2_cop,inva3_cop,inva1_tant_cop,
    inva2_tant_cop,inva3_tant_cop,invr1_maximo_tant_cop,invr2_maximo_tant_cop,invr3_maximo_tant_cop,invr1_delta_cop,
    invr2_delta_cop,invr3_delta_cop,invr1_tant_cop,invr2_tant_cop,invr3_tant_cop,pr1,pr2,pr3,pj_1,pj_2,pj_3,pj_1_creg097,pj_2_creg097,pj_3_creg097,acumulado_eej1_kwh,acumulado_eej2_kwh,acumulado_eej3_kwh,acumulado_fej3_2_kwh,euj_2_creg097_kwh,fej3_2_creg097_kwh,ic_saidi_cop)
   console.log("creador"+cargo_nivel_de_tension_cd4_cop_kwh)
