...
const Data_mme_giro = () => {
  ...
  const headers = [
    ...
    { name: "Fondo", field: "fondo", sortable: true },
    { name: "Resolucion", field: "resolucion", sortable: true },
    { name: "Link_Resolucion", field: "link_resolucion", sortable: true },
    { name: "Giro_Cop", field: "giro_cop", sortable: true },
  ];
  useEffect(() => {
    if (loading) return "Cargando....";
    if (loading1) return "Cargando....";
    const data_obtenerData_mme_giroesp_ = data.obtenerData_mme_giro;
    const data_obtenerData_mme_giroesp = data_obtenerData_mme_giroesp_.filter(
      (data_obtenerData_mme_giroesp_) =>
        data_obtenerData_mme_giroesp_.empresa_id ===
        data1.obtenerUsuario.empresa
    );
    setComments(
      [...data_obtenerData_mme_giroesp].sort((a, b) => {
