...
pcsub:{type: DataTypes.FLOAT,allowNull: false,trim: true},
...
w1:{type: DataTypes.FLOAT,allowNull: false,trim: true},
w2:{type: DataTypes.FLOAT,allowNull: false,trim: true},
alfa:{type: DataTypes.FLOAT,allowNull: false,trim: true},
gc:{type: DataTypes.FLOAT,allowNull: false,trim: true},
delta_t:{type: DataTypes.FLOAT,allowNull: false,trim: true},
t_prima:{type: DataTypes.FLOAT,allowNull: false,trim: true},
tx:{type: DataTypes.FLOAT,allowNull: false,trim: true},
dtun_nt1_e:{type: DataTypes.FLOAT,allowNull: true,trim: true},
dtun_nt1_c:{type: DataTypes.FLOAT,allowNull: true,trim: true},
dtun_nt1_p:{type: DataTypes.FLOAT,allowNull: true,trim: true},
dtun_nt2:{type: DataTypes.FLOAT,allowNull: true,trim: true},
dtun_nt3:{type: DataTypes.FLOAT,allowNull: true,trim: true},
...
guatape:{type: DataTypes.FLOAT,allowNull: false,trim: true},
ventas_desv:{type: DataTypes.FLOAT,allowNull: false,trim: true},
restricciones_aliviadas:{type: DataTypes.FLOAT,allowNull: false,trim: true},
ventas_totales:{type: DataTypes.FLOAT,allowNull: false,trim: true},
data_xm_iprm1:{type: DataTypes.FLOAT,allowNull: false,trim: true},
data_xm_iprm2:{type: DataTypes.FLOAT,allowNull: false,trim: true},
data_xm_iprm3:{type: DataTypes.FLOAT,allowNull: false,trim: true},
data_xm_iprm4:{type: DataTypes.FLOAT,allowNull: false,trim: true},
crs:{type: DataTypes.FLOAT,allowNull: false,trim: true},
rcal:{type: DataTypes.FLOAT,allowNull: true,trim: true},
