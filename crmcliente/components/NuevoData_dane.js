...
value={formik.values.mes}></input></div>
        ...
        <label htmlFor="ipp_oferta_interna"className="col-sm-7 col-form-label">Ipp_Oferta_Interna</label><div className="col-sm-3">
...
value={formik.values.ipp_oferta_interna}></input></div>
        ...
        <label htmlFor="ipc"className="col-sm-7 col-form-label">Ipc</label><div className="col-sm-3">
