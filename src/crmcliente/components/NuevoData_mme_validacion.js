...
const [creador, setcreador] = useState("");const [empresa_id, setempresa_id] = useState("");const [fecha, setFecha] = useState("");const [trimestre, setTrimestre] = useState("");const [anho, setAnho] = useState("");const [subsidios, setSubsidios] = useState("");const [contribuciones, setContribuciones] = useState("");const [contrib_no_recaud_desp_6m, setContrib_No_Recaud_Desp_6M] = useState("");const [contrib_recaud_desp_de_conc, setContrib_Recaud_Desp_De_Conc] = useState("");const [giros_recibidos, setGiros_Recibidos] = useState("");
...
initialValues: {
creador:creador,empresa_id:empresa_id,fecha:fecha,trimestre:trimestre,anho:anho,subsidios:subsidios,contribuciones:contribuciones,contrib_no_recaud_desp_6m:contrib_no_recaud_desp_6m,contrib_recaud_desp_de_conc:contrib_recaud_desp_de_conc,giros_recibidos:giros_recibidos
},
...
const{creador,empresa_id,fecha,trimestre,anho,subsidios,contribuciones,contrib_no_recaud_desp_6m,contrib_recaud_desp_de_conc,giros_recibidos}=valores
...
variables:{
input:{
creador,empresa_id,fecha,trimestre,anho,subsidios,contribuciones,contrib_no_recaud_desp_6m,contrib_recaud_desp_de_conc,giros_recibidos
}
}
});
} catch (error) {
...
var Position=(datacsv[0].indexOf(("Fecha").toString()))
           ...
           setAnho(parseFloat(datacsv[1][Position]));var Position=(datacsv[0].indexOf(("subsidios").toString()))
