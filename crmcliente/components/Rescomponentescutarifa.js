...
const Res_componentes_cu_tarifa = () => {
  ...
  const headers = [
    ...
    { name: "Qc", field: "qc", sortable: true },
    { name: "Pc", field: "pc", sortable: true },
    { name: "Ref_G", field: "ref_g", sortable: true },
    { name: "Max_G", field: "max_g", sortable: true },
    { name: "Cr", field: "cr", sortable: true },
    { name: "Ad", field: "ad", sortable: true },
    { name: "Aj", field: "aj", sortable: true },
    { name: "Pb", field: "pb", sortable: true },
    { name: "Gc", field: "gc", sortable: true },
    { name: "Tx", field: "tx", sortable: true },
    { name: "Dtun_Nt1_E", field: "dtun_nt1_e", sortable: true },
    { name: "Dtun_Nt1_C", field: "dtun_nt1_c", sortable: true },
    { name: "Dtun_Nt1_P", field: "dtun_nt1_p", sortable: true },
    { name: "Dtun_Nt2", field: "dtun_nt2", sortable: true },
    { name: "Dtun_Nt3", field: "dtun_nt3", sortable: true },
    { name: "Cdi_100", field: "cdi_100", sortable: true },
    { name: "Cdi_50", field: "cdi_50", sortable: true },
    { name: "Cdm", field: "cdm", sortable: true },
    { name: "Cd4", field: "cd4", sortable: true },
    { name: "Cd3", field: "cd3", sortable: true },
    { name: "Cd2", field: "cd2", sortable: true },
    { name: "Dnt1", field: "dnt1", sortable: true },
    { name: "Dnt2", field: "dnt2", sortable: true },
    { name: "Dnt3", field: "dnt3", sortable: true },
    { name: "Dnt4", field: "dnt4", sortable: true },
    { name: "Crs", field: "crs", sortable: true },
    { name: "Rcal", field: "rcal", sortable: true },
    { name: "R", field: "r", sortable: true },
    { name: "Iprstn", field: "iprstn", sortable: true },
    { name: "Pr_Nt1", field: "pr_nt1", sortable: true },
    { name: "Pr_Nt2", field: "pr_nt2", sortable: true },
    { name: "Pr_Nt3", field: "pr_nt3", sortable: true },
    { name: "Pr_Nt4", field: "pr_nt4", sortable: true },
    { name: "Cer", field: "cer", sortable: true },
    { name: "Cfm", field: "cfm", sortable: true },
    { name: "Rc", field: "rc", sortable: true },
    { name: "Ul_Trim_Val_Mme", field: "ul_trim_val_mme", sortable: true },
    {
      name: "Anho_Ul_Trim_Val_Mme",
      field: "anho_ul_trim_val_mme",
      sortable: true,
    },
    { name: "Sub1", field: "sub1", sortable: true },
    { name: "Sub2", field: "sub2", sortable: true },
    { name: "N_Sub1", field: "n_sub1", sortable: true },
    { name: "M_Sub2", field: "m_sub2", sortable: true },
    { name: "Facturacion_T", field: "facturacion_t", sortable: true },
    { name: "R1", field: "r1", sortable: true },
    { name: "R2", field: "r2", sortable: true },
    { name: "Sup_Def", field: "sup_def", sortable: true },
    { name: "Cfs", field: "cfs", sortable: true },
    { name: "Cfe", field: "cfe", sortable: true },
    { name: "C_Ast", field: "c_ast", sortable: true },
    { name: "CG", field: "cg", sortable: true },
    { name: "CGCU", field: "cgcu", sortable: true },
    { name: "Cvr", field: "cvr", sortable: true },
    { name: "Cv", field: "cv", sortable: true },
    { name: "Cu_Nt1_100", field: "cu_nt1_100", sortable: true },
    { name: "Cu_Nt1_50", field: "cu_nt1_50", sortable: true },
    { name: "Cu_Nt1_0", field: "cu_nt1_0", sortable: true },
    { name: "Cu_Nt2", field: "cu_nt2", sortable: true },
  ...
  useEffect(() => {
    ...
    const data_Res_componentes_cu_tarifaesp_ =
      data.obtenerRes_componentes_cu_tarifa;
    const data_Res_componentes_cu_tarifaesp =
      data_Res_componentes_cu_tarifaesp_.filter(
        (data_Res_componentes_cu_tarifaesp_) =>
          data_Res_componentes_cu_tarifaesp_.empresa_id ===
          data3.obtenerUsuario.empresa
      );
    ...
    Swal.fire({
      ...
      if (result.value) {
        try {
          ...
          const data_Res_componentes_cu_tarifam =
            data_Res_componentes_cu_tarifa.filter(
              (data_Res_componentes_cu_tarifa) =>
                data_Res_componentes_cu_tarifa.id === id
            );
          await downloadExcel(
            "Memorias " +
              data_Res_componentes_cu_tarifam[0].anho +
              "-" +
              data_Res_componentes_cu_tarifam[0].mes,
            "Memorias " +
              data_Res_componentes_cu_tarifam[0].anho +
              "-" +
              data_Res_componentes_cu_tarifam[0].mes +
          ...
          Swal.fire(
            "Exportado",
            data_Res_componentes_cu_tarifam.anho +
              "-" +
              data_Res_componentes_cu_tarifam.mes,
            "success"
          );
        } catch (error) {
          console.log(error);
    ...
    Swal.fire({
      ...
      if (result.value) {
        try {
          ...
          const data_empresam = data_empresa.filter(
            (data_empresa) =>
              data_empresa.anho === anhom &&
              data_empresa.mes === mesm &&
              data_empresa.empresa_id === data3.obtenerUsuario.empresa
          );

          const data_Res_componentes_cu_tarifam1 =
            data_Res_componentes_cu_tarifa.filter(
              (data_Res_componentes_cu_tarifa) =>
          ...
          if (
            data_Res_componentes_cu_tarifam[0].cg > 0 ||
            data_Res_componentes_cu_tarifam[0].cgcu > 0
          ) {
          ...
          const data_empresa_garantiasm = data_empresa_garantias.filter(
            (data_empresa_garantias) =>
              ...
              Date.parse(data_empresa_garantias.fecha_fin_vigencia) >=
                Date.parse(new Date(anhom2, mesm2, 30)) &&
              data_empresa_garantias.empresa_id === data3.obtenerUsuario.empresa
          );
          ...
          for (let index = 0; index < data_empresa_garantiasm.length; index++) {
            meses_garantizados = dateRange(
              data_empresa_garantias[index].fecha_inicio_vigencia,
              data_empresa_garantias[index].fecha_fin_vigencia
            );
            console.log(meses_garantizados);
            if (
              data_empresa_garantias[index].tipo_garantia === "Subasta_FERNC"
            ) {
              tipo_garantia = 1;
            }
            ...
            formato_2_sspd.push({
              ...
              "NIT Beneficiario":
                data_empresa_garantiasm[index].nit_beneficiario,
              ...
              "Valor Total Garantía":
                data_empresa_garantiasm[index].valor_garantia,
          ...
          for (let index = 1; index < 11; index++) {
            if (opcionTarifaria == 1) {
              ...
              if (index === 3) {
                ...
                Tarifa_NT2 =
                  data_Res_componentes_cu_tarifam[0].cu_nt2_ot * 0.85;
                Tarifa_NT3 =
                  data_Res_componentes_cu_tarifam[0].cu_nt3_ot * 0.85;
                Tarifa_NT4 =
                  data_Res_componentes_cu_tarifam[0].cu_nt4_ot * 0.85;
              }
              ...
              if (index < 4) {
                formato_3_sspd.push({
                  ...
                  "% Subsidiado 100% OR": roundToTwo(
                    (1 -
                      Tarifa_100 /
                        data_Res_componentes_cu_tarifam[0].cu_nt1_100_ot) *
                      100
                  ),
                  "% Subsidiado 50% OR": roundToTwo(
                    (1 -
                      Tarifa_50 /
                        data_Res_componentes_cu_tarifam[0].cu_nt1_50_ot) *
                      100
                  ),
                  "% Subsidiado 0% OR": roundToTwo(
                    (1 -
                      Tarifa_0 /
                        data_Res_componentes_cu_tarifam[0].cu_nt1_0_ot) *
                      100
                  ),
          ...
          const formulario_5_sspd = [
            {
              "¿Aplicó la empresa para este mes la opción tarifaria?:":
                opcionTarifaria,
            },
          ];
          ...
          const data_xm_dspcttom = data_xm_dspctto.filter(
            (data_xm_dspctto) =>
              ...
              data_xm_dspctto.comprador === data3.obtenerUsuario.empresa &&
          ...
          const data_xm_afacm = data_xm_afac.filter(
            (data_xm_afac) =>
              data_xm_afac.anho === anhom &&
              data_xm_afac.mes === mesm &&
              data_xm_afac.agente === data3.obtenerUsuario.empresa
          );
          var w = 0;
          console.log("ACA");
          console.log(data_xm_afac);
          if (
            data_xm_afacm[0].compras_en_contratos_kwh /
          ...
          const data_empresaanualm = data_empresa_anual.filter(
            (data_empresa_anual) =>
              data_empresa_anual.anho ===
              data_Res_componentes_cu_tarifam[0].anho - 1
          );
