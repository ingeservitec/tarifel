...
const [nt1_50_100_estrato_1_men_cs, setNt1_50_100_Estrato_1_Men_Cs] = useState(0);
const [nt1_50_100_estrato_2_men_cs, setNt1_50_100_Estrato_2_Men_Cs] = useState(0);
const [nt1_50_100_estrato_3_men_cs, setNt1_50_100_Estrato_3_Men_Cs] = useState(0);
const [nt1_50_100_estrato_4_men_cs, setNt1_50_100_Estrato_4_Men_Cs] = useState(0);const [nt1_50_100_estrato_5_men_cs, setNt1_50_100_Estrato_5_Men_Cs] = useState(0);
const [nt1_50_100_estrato_6_men_cs, setNt1_50_100_Estrato_6_Men_Cs] = useState(0);const [nt1_50_100_estrato_4, setNt1_50_100_Estrato_4] = useState(0);
const [nt1_50_100_estrato_5, setNt1_50_100_Estrato_5] = useState(0);const [nt1_50_100_estrato_6, setNt1_50_100_Estrato_6] = useState(0);
const [nt1_50_100_c, setNt1_50_100_C] = useState(0);const [nt1_50_100_i_con_c, setNt1_50_100_I_Con_C] = useState(0);
const [nt1_50_100_i_sin_c, setNt1_50_100_I_Sin_C] = useState(0);const [nt1_50_100_p, setNt1_50_100_P] = useState(0);
const [nt1_50_100_o, setNt1_50_100_O] = useState(0);const [nt1_0_estrato_1_men_cs, setNt1_0_Estrato_1_Men_Cs] = useState(0);
...
useEffect(() => {
        ...
        if(!loading1 && !loading2 && !loading3 && !loading4 && !loading5 && !loading6 && !loading7 && !loading8 && !loading9 && !loading9 && !loading10 && !loading11
                ...
                // try{
                        ...
                        const data_danem=data_dane.filter(data_dane => data_dane.anho===anhom && data_dane.mes===mesm)
                        ...
                        const data_banrepublica_tcom=data_banrepublica_tco.filter(data_banrepublica_tco => data_banrepublica_tco.anho===anhom && data_banrepublica_tco.mes===mesm)
                        const data_banrepublica_tcap=data13.obtenerData_banrepublica_tcap
                        const data_banrepublica_tcapm=data_banrepublica_tcap.filter(data_banrepublica_tcap => data_banrepublica_tcap.anho===anhom && data_banrepublica_tcap.mes===mesm)
                        ...
                        console.log(data_empresaanualm[0].contribuciones_creg+data_empresaanualm[0].contribuciones_sspd)
                        ...
                        data_creg_cxm[0].RCAE*(data_empresam[0].vae_kwh)+data_creg_cxm[0].RCSNE*(data_empresam[0].vsne_kwh)+data_creg_cxm[0].RCNU*(data_empresam[0].vnu_kwh))/(data_empresam[0].ventas_usuarios_r_nt1_e+
                                ...
                                data_empresam[0].ventas_usuarios_r_nt2+
                                data_empresam[0].ventas_usuarios_r_nt3))
                        // setC_Ast((data_Res_componentes_cu_tarifam[0].gc+data_Res_componentes_cu_tarifam[0].tx+data_Res_componentes_cu_tarifam[0].dtun_nt1_e+data_Res_componentes_cu_tarifam[0].pr_nt1+data_Res_componentes_cu_tarifam[0].r)*(0.0273+0+0))
                        setC_Ast(20.52)
                        console.log(data_xm_tservmsiciva)
                        setCv(((((data_empresaanualm[0].contribuciones_creg+data_empresaanualm[0].contribuciones_sspd)/12)+
                        ...
                        console.log('A continuacion Validaciones')
                        console.log(data_xm_mme_validacion)
                        ...
                        var len = data_xm_mme_validacion.length, summ = 0, defsub1, defsub2, defsub3, defsub4, tri_primer_tri_val,anho_primer_tri_val,tri_segundo_tri_val,anho_segundo_tri_val,tri_tercer_tri_val,anho_tercer_tri_val,tri_cuarto_tri_val,anho_cuarto_tri_val;
                        while (len>0) {
                        len--                          
                        ...
                        console.log(data_mme_giro_ordenado)
                        const oneDay = 24 * 60 * 60 * 1000; // hours*minutes*seconds*milliseconds
                       
                        var len1 = 4, len2, summ = 0, defsub1, defsub2, defsub3, defsub4, array_sub2M=[],saldo=Infinity;
                        while (len1>0) {
                        len1-- 
                        len2 = 0
                        while (len2<data_mme_giro_ordenado.length-1) {
                        len2++
                        console.log('PRUEBA1')
                        console.log(tri_primer_tri_val)
                        console.log(len1)
                        console.log(len2)
                        if(len1===3 && tri_primer_tri_val===1 &&(data_mme_giro_ordenado[len2].fondo==='FSSRI' &&  parseFloat(data_mme_giro_ordenado[len2].fecha.substr(0,4))===maxa && (parseFloat(data_mme_giro_ordenado[len2].fecha.substr(5,2))===1||parseFloat(data_mme_giro_ordenado[len2].fecha.substr(5,2))===2||parseFloat(data_mme_giro_ordenado[len2].fecha.substr(5,2))===3) )){
                                console.log('PRUEBA2')
                        if (saldo>0){
                        saldo=defsub1-data_mme_giro_ordenado.giro_cop
                        array_sub2M[array_sub2M.length+1,0]=data_mme_giro_ordenado[len2].giro_cop
                        ...
                        array_sub2M[array_sub2M.length+1,1]=Math.round(Math.abs((firstDate - secondDate) / oneDay));
                        console.log(array_sub2M)
                        console.log(defsub1)
                        }
                        }
