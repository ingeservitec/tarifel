...
const [creador, setcreador] = useState("");const [anho, setAnho] = useState(props.anho);const [mes, setMes] = useState(props.mes);const [qc, setQc] = useState("");
const [pc, setPc] = useState("");const [ref_g, setRef_G] = useState("");const [max_g, setMax_G] = useState("");const [cr, setCr] = useState("");
const [ad, setAd] = useState("");const [aj, setAj] = useState(0);const [pb, setPb] = useState("");const [gc, setGc] = useState("");
const [tx, setTx] = useState("");const [dtun_nt1_e, setDtun_Nt1_E] = useState("");const [dtun_nt1_c, setDtun_Nt1_C] = useState("");
const [dtun_nt1_p, setDtun_Nt1_P] = useState("");const [dtun_nt2, setDtun_Nt2] = useState("");const [dtun_nt3, setDtun_Nt3] = useState("");
const [cdi_100, setCdi_100] = useState("");const [cdi_50, setCdi_50] = useState("");const [cdm, setCdm] = useState("");const [cd4, setCd4] = useState("");
const [cd3, setCd3] = useState("");const [cd2, setCd2] = useState("");const [dnt1, setDnt1] = useState("");const [dnt2, setDnt2] = useState("");
const [dnt3, setDnt3] = useState("");const [dnt4, setDnt4] = useState("");const [crs, setCrs] = useState("");const [rcal, setRcal] = useState("")
;const [r, setR] = useState("");const [iprstn, setIprstn] = useState("");const [pr_nt1, setPr_Nt1] = useState("");
const [pr_nt2, setPr_Nt2] = useState("");const [pr_nt3, setPr_Nt3] = useState("");const [pr_nt4, setPr_Nt4] = useState("");
const [cer, setCer] = useState("");const [cfm, setCfm] = useState("");const [rc, setRc] = useState("");const [ul_trim_val_mme, setUl_Trim_Val_Mme] = useState("");
const [anho_ul_trim_val_mme, setAnho_Ul_Trim_Val_Mme] = useState("");const [sub1, setSub1] = useState("");const [sub2, setSub2] = useState("");
const [n_sub1, setN_Sub1] = useState("");const [m_sub2, setM_Sub2] = useState("");const [facturacion_t, setFacturacion_T] = useState("");
const [r1, setR1] = useState("");const [r2, setR2] = useState("");const [sup_def, setSup_Def] = useState("");const [cfs, setCfs] = useState("");
const [cfe, setCfe] = useState("");const [c_ast, setC_Ast] = useState("");const [cvr, setCvr] = useState("");const [cv, setCv] = useState("");
const [cu_nt1_100, setCu_Nt1_100] = useState("");const [cu_nt1_50, setCu_Nt1_50] = useState("");const [cu_nt1_0, setCu_Nt1_0] = useState("");
const [cu_nt2, setCu_Nt2] = useState("");const [cu_nt3, setCu_Nt3] = useState("");const [cu_nt4, setCu_Nt4] = useState("");
const [nt1_100_estrato_1_men_cs, setNt1_100_Estrato_1_Men_Cs] = useState("");const [nt1_100_estrato_2_men_cs, setNt1_100_Estrato_2_Men_Cs] = useState("");
const [nt1_100_estrato_3_men_cs, setNt1_100_Estrato_3_Men_Cs] = useState("");const [nt1_100_estrato_4_men_cs, setNt1_100_Estrato_4_Men_Cs] = useState("");
const [nt1_100_estrato_5_men_cs, setNt1_100_Estrato_5_Men_Cs] = useState("");const [nt1_100_estrato_6_men_cs, setNt1_100_Estrato_6_Men_Cs] = useState("");
const [nt1_100_estrato_4, setNt1_100_Estrato_4] = useState("");const [nt1_100_estrato_5, setNt1_100_Estrato_5] = useState("");
const [nt1_100_estrato_6, setNt1_100_Estrato_6] = useState("");const [nt1_100_c, setNt1_100_C] = useState("");const [nt1_100_i_con_c, setNt1_100_I_Con_C] = useState("");
const [nt1_100_i_sin_c, setNt1_100_I_Sin_C] = useState("");const [nt1_100_p, setNt1_100_P] = useState("");const [nt1_100_o, setNt1_100_O] = useState("");
const [nt1_50_100_estrato_1_men_cs, setNt1_50_100_Estrato_1_Men_Cs] = useState("");
const [nt1_50_100_estrato_2_men_cs, setNt1_50_100_Estrato_2_Men_Cs] = useState("");
const [nt1_50_100_estrato_3_men_cs, setNt1_50_100_Estrato_3_Men_Cs] = useState("");
const [nt1_50_100_estrato_4_men_cs, setNt1_50_100_Estrato_4_Men_Cs] = useState("");const [nt1_50_100_estrato_5_men_cs, setNt1_50_100_Estrato_5_Men_Cs] = useState("");
const [nt1_50_100_estrato_6_men_cs, setNt1_50_100_Estrato_6_Men_Cs] = useState("");const [nt1_50_100_estrato_4, setNt1_50_100_Estrato_4] = useState("");
const [nt1_50_100_estrato_5, setNt1_50_100_Estrato_5] = useState("");const [nt1_50_100_estrato_6, setNt1_50_100_Estrato_6] = useState("");
const [nt1_50_100_c, setNt1_50_100_C] = useState("");const [nt1_50_100_i_con_c, setNt1_50_100_I_Con_C] = useState("");
const [nt1_50_100_i_sin_c, setNt1_50_100_I_Sin_C] = useState("");const [nt1_50_100_p, setNt1_50_100_P] = useState("");
const [nt1_50_100_o, setNt1_50_100_O] = useState("");const [nt1_0_estrato_1_men_cs, setNt1_0_Estrato_1_Men_Cs] = useState("");
const [nt1_0_estrato_2_men_cs, setNt1_0_Estrato_2_Men_Cs] = useState("");const [nt1_0_estrato_3_men_cs, setNt1_0_Estrato_3_Men_Cs] = useState("");
const [nt1_0_estrato_4_men_cs, setNt1_0_Estrato_4_Men_Cs] = useState("");const [nt1_0_estrato_5_men_cs, setNt1_0_Estrato_5_Men_Cs] = useState("");
const [nt1_0_estrato_6_men_cs, setNt1_0_Estrato_6_Men_Cs] = useState("");const [nt1_0_estrato_4, setNt1_0_Estrato_4] = useState("");
const [nt1_0_estrato_5, setNt1_0_Estrato_5] = useState("");const [nt1_0_estrato_6, setNt1_0_Estrato_6] = useState("");
const [nt1_0_c, setNt1_0_C] = useState("");const [nt1_0_i_con_c, setNt1_0_I_Con_C] = useState("");const [nt1_0_i_sin_c, setNt1_0_I_Sin_C] = useState("");
const [nt1_0_p, setNt1_0_P] = useState("");const [nt1_0_o, setNt1_0_O] = useState("");const [nt2_c, setNt2_C] = useState("");
const [nt2_i_con_c, setNt2_I_Con_C] = useState("");const [nt2_i_sin_c, setNt2_I_Sin_C] = useState("");const [nt2_o, setNt2_O] = useState("");
const [nt2_ap, setNt2_Ap] = useState("");const [nt2_bsnmen_cs, setNt2_Bsnmen_Cs] = useState("");const [nt2_bsnmay_cs, setNt2_Bsnmay_Cs] = useState("");
const [nt3_c, setNt3_C] = useState("");const [nt3_i_con_c, setNt3_I_Con_C] = useState("");const [nt3_i_sin_c, setNt3_I_Sin_C] = useState("");
const [nt3_o, setNt3_O] = useState("");const [nt3_ap, setNt3_Ap] = useState("");const [empresa_id, setempresa_id] = useState("");
useEffect(() => {
        ...
        const formik=useFormik({
          initialValues: {
          creador:creador,anho:anho,mes:mes,qc:qc,pc:pc,ref_g:ref_g,max_g:max_g,cr:cr,ad:ad,aj:aj,pb:pb,gc:gc,tx:tx,dtun_nt1_e:dtun_nt1_e,dtun_nt1_c:dtun_nt1_c,dtun_nt1_p:dtun_nt1_p,dtun_nt2:dtun_nt2,dtun_nt3:dtun_nt3,cdi_100:cdi_100,cdi_50:cdi_50,cdm:cdm,cd4:cd4,cd3:cd3,cd2:cd2,dnt1:dnt1,dnt2:dnt2,dnt3:dnt3,dnt4:dnt4,crs:crs,rcal:rcal,r:r,iprstn:iprstn,pr_nt1:pr_nt1,pr_nt2:pr_nt2,pr_nt3:pr_nt3,pr_nt4:pr_nt4,cer:cer,cfm:cfm,rc:rc,ul_trim_val_mme:ul_trim_val_mme,anho_ul_trim_val_mme:anho_ul_trim_val_mme,sub1:sub1,sub2:sub2,n_sub1:n_sub1,m_sub2:m_sub2,facturacion_t:facturacion_t,r1:r1,r2:r2,sup_def:sup_def,cfs:cfs,cfe:cfe,c_ast:c_ast,cvr:cvr,cv:cv,cu_nt1_100:cu_nt1_100,cu_nt1_50:cu_nt1_50,cu_nt1_0:cu_nt1_0,cu_nt2:cu_nt2,cu_nt3:cu_nt3,cu_nt4:cu_nt4,nt1_100_estrato_1_men_cs:nt1_100_estrato_1_men_cs,nt1_100_estrato_2_men_cs:nt1_100_estrato_2_men_cs,nt1_100_estrato_3_men_cs:nt1_100_estrato_3_men_cs,nt1_100_estrato_4_men_cs:nt1_100_estrato_4_men_cs,nt1_100_estrato_5_men_cs:nt1_100_estrato_5_men_cs,nt1_100_estrato_6_men_cs:nt1_100_estrato_6_men_cs,nt1_100_estrato_4:nt1_100_estrato_4,nt1_100_estrato_5:nt1_100_estrato_5,nt1_100_estrato_6:nt1_100_estrato_6,nt1_100_c:nt1_100_c,nt1_100_i_con_c:nt1_100_i_con_c,nt1_100_i_sin_c:nt1_100_i_sin_c,nt1_100_p:nt1_100_p,nt1_100_o:nt1_100_o,nt1_50_100_estrato_1_men_cs:nt1_50_100_estrato_1_men_cs,nt1_50_100_estrato_2_men_cs:nt1_50_100_estrato_2_men_cs,nt1_50_100_estrato_3_men_cs:nt1_50_100_estrato_3_men_cs,nt1_50_100_estrato_4_men_cs:nt1_50_100_estrato_4_men_cs,nt1_50_100_estrato_5_men_cs:nt1_50_100_estrato_5_men_cs,nt1_50_100_estrato_6_men_cs:nt1_50_100_estrato_6_men_cs,nt1_50_100_estrato_4:nt1_50_100_estrato_4,nt1_50_100_estrato_5:nt1_50_100_estrato_5,nt1_50_100_estrato_6:nt1_50_100_estrato_6,nt1_50_100_c:nt1_50_100_c,nt1_50_100_i_con_c:nt1_50_100_i_con_c,nt1_50_100_i_sin_c:nt1_50_100_i_sin_c,nt1_50_100_p:nt1_50_100_p,nt1_50_100_o:nt1_50_100_o,nt1_0_estrato_1_men_cs:nt1_0_estrato_1_men_cs,nt1_0_estrato_2_men_cs:nt1_0_estrato_2_men_cs,nt1_0_estrato_3_men_cs:nt1_0_estrato_3_men_cs,nt1_0_estrato_4_men_cs:nt1_0_estrato_4_men_cs,nt1_0_estrato_5_men_cs:nt1_0_estrato_5_men_cs,nt1_0_estrato_6_men_cs:nt1_0_estrato_6_men_cs,nt1_0_estrato_4:nt1_0_estrato_4,nt1_0_estrato_5:nt1_0_estrato_5,nt1_0_estrato_6:nt1_0_estrato_6,nt1_0_c:nt1_0_c,nt1_0_i_con_c:nt1_0_i_con_c,nt1_0_i_sin_c:nt1_0_i_sin_c,nt1_0_p:nt1_0_p,nt1_0_o:nt1_0_o,nt2_c:nt2_c,nt2_i_con_c:nt2_i_con_c,nt2_i_sin_c:nt2_i_sin_c,nt2_o:nt2_o,nt2_ap:nt2_ap,nt2_bsnmen_cs:nt2_bsnmen_cs,nt2_bsnmay_cs:nt2_bsnmay_cs,nt3_c:nt3_c,nt3_i_con_c:nt3_i_con_c,nt3_i_sin_c:nt3_i_sin_c,nt3_o:nt3_o,nt3_ap:nt3_ap,empresa_id:empresa_id
          },
...
useEffect(() => {
        ...
        if(!loading1 && !loading2 && !loading3 && !loading4 && !loading5 && !loading6 && !loading7 && !loading8 && !loading9 && !loading9 && !loading10 && !loading11
                && !loading12 && !loading13  && !loading14  && !loading15  && !loading16  && !loading17 && !loading18 && !loading19){
                const data_xm_afac=data7.obtenerData_xm_afac
                const data_xm_afacm=data_xm_afac.filter(data_xm_afac => data_xm_afac.anho===anho && data_xm_afac.mes===mes-1 && data_xm_afac.agente===data2.obtenerUsuario.empresa)
                const data_xm_dspctto=data6.obtenerData_xm_dspctto
                const data_xm_dspcttom=data_xm_dspctto.filter(data_xm_dspctto => data_xm_dspctto.anho===anho && data_xm_dspctto.mes===mes-1 && data_xm_dspctto.comprador===data2.obtenerUsuario.empresa && data_xm_dspctto.tipomerc==='R')
                const data_xm_trsm=data5.obtenerData_xm_trsm
                const data_xm_trsmm=data_xm_trsm.filter(data_xm_trsm => data_xm_trsm.anho===anho && data_xm_trsm.mes===mes-1)
                ...
                const data_empresa=data3.obtenerData_empresa
                const data_empresam=data_empresa.filter(data_empresa => data_empresa.anho===anho && data_empresa.mes===mes-1)
                const data_xm_ipr=data16.obtenerData_xm_ipr
                const data_xm_iprm1=data_xm_ipr.filter(data_xm_ipr => data_xm_ipr.anho===anho && data_xm_ipr.mes===mes-1 && data_xm_ipr.agrupaORMercado==='ARAM' && data_xm_ipr.nivelEntrada===1)
                const data_xm_iprm2=data_xm_ipr.filter(data_xm_ipr => data_xm_ipr.anho===anho && data_xm_ipr.mes===mes-1 && data_xm_ipr.agrupaORMercado==='ARAM' && data_xm_ipr.nivelEntrada===2)
                const data_xm_iprm3=data_xm_ipr.filter(data_xm_ipr => data_xm_ipr.anho===anho && data_xm_ipr.mes===mes-1 && data_xm_ipr.agrupaORMercado==='ARAM' && data_xm_ipr.nivelEntrada===3)
                const data_xm_iprm4=data_xm_ipr.filter(data_xm_ipr => data_xm_ipr.anho===anho && data_xm_ipr.mes===mes-1 && data_xm_ipr.agrupaORMercado==='ARAM' && data_xm_ipr.nivelEntrada===4)
                const data_xm_cprog=data15.obtenerData_xm_cprog
                const data_xm_cprogm=data_xm_cprog.filter(data_xm_cprog => data_xm_cprog.anho===anho && data_xm_cprog.mes===mes && data_xm_cprog.agente===data2.obtenerUsuario.empresa)
                const data_xm_dtun=data18.obtenerData_xm_dtun
                const data_xm_dtunm1=data_xm_dtun.filter(data_xm_dtun => data_xm_dtun.anho===anho && data_xm_dtun.mes===mes && data_xm_dtun.operador_red==='ENELAR Mercado de Comercialización ARAUCA'  && data_xm_dtun.nivel_tension===1)                        
                const data_xm_dtunm2=data_xm_dtun.filter(data_xm_dtun => data_xm_dtun.anho===anho && data_xm_dtun.mes===mes && data_xm_dtun.operador_red==='ENELAR Mercado de Comercialización ARAUCA'  && data_xm_dtun.nivel_tension===2)            
                const data_xm_dtunm3=data_xm_dtun.filter(data_xm_dtun => data_xm_dtun.anho===anho && data_xm_dtun.mes===mes && data_xm_dtun.operador_red==='ENELAR Mercado de Comercialización ARAUCA'  && data_xm_dtun.nivel_tension===3)            
                ...
                const data_dane=data1.obtenerData_dane
                const data_danem=data_dane.filter(data_dane => data_dane.anho===anho && data_dane.mes===mes-1)

                const data_xm_tserv=data4.obtenerData_xm_tserv
                const data_xm_tservm=data_xm_tserv.filter(data_xm_tserv => data_xm_tserv.anho===anho && data_xm_tserv.mes===mes-1)


                const data_xm_adem=data8.obtenerData_xm_adem
                const data_xm_ademm=data_xm_adem.filter(data_xm_adem => data_xm_adem.anho===anho && data_xm_adem.mes===mes-1)
                const data_xm_mme_validacion=data9.obtenerData_mme_validacion
                const data_xm_mme_validacionm=data_xm_mme_validacion.filter(data_xm_mme_validacion => data_xm_mme_validacion.anho===anho && data_xm_mme_validacion.mes===mes-1)
                const data_mme_giro=data10.obtenerData_mme_giro
                const data_mme_girom=data_mme_giro.filter(data_mme_giro => data_mme_giro.anho===anho && dat_mme_giro.mes===mes-1)
                const data_creg_cx=data11.obtenerData_creg_cx
                const data_creg_cxm=data_creg_cx.filter(data_creg_cx => data_creg_cx.anho===anho && data_creg_cx.mes===mes-1)
                const data_banrepublica_tco=data12.obtenerData_banrepublica_tco
                const data_banrepublica_tcom=data_banrepublica_tco.filter(data_banrepublica_tco => data_banrepublica_tco.anho===anho && data_banrepublica_tco.mes===mes-1)
                const data_banrepublica_tcap=data13.obtenerData_banrepublica_tcap
                const data_banrepublica_tcapm=data_banrepublica_tcap.filter(data_banrepublica_tcap => data_banrepublica_tcap.anho===anho && data_banrepublica_tcap.mes===mes-1)
                ...
                if (data_xm_afacm[0].compras_en_bolsa_nacional_kwh===0){
                  ...
                  setPb(data_xm_afacm[0].compras_energia_en_bolsa_cop/data_xm_afacm[0].compras_energia_en_bolsa_kwh)
                }
                ...
                const Mc=data_xm_trsmm.filter(data_xm_trsmm => data_xm_trsmm.codigo==='MC')[0].valor
                console.log(Mc)
                ...
                setR(crs/(data_empresam[0].ventas_usuarios_r_nt1_e+
        ...
        },[],[loading1,loading2,loading3,loading4,loading5,loading6,loading7,loading8,loading9,loading9,loading10,loading11,loading12,loading13,loading14,loading15,loading16,loading17,loading18]);        
  return (
    <div>
    ...
    value={formik.values.mes}></input></div></div>
            ...
            <label htmlFor="qc"className="col-sm-7 col-form-label">Qc</label><div className="col-sm-3">
    ...
    value={formik.values.qc}></input></div></div>
            ...
            <label htmlFor="pc"className="col-sm-7 col-form-label">Pc</label><div className="col-sm-3">
    ...
    value={formik.values.pc}></input></div></div>
            ...
            <label htmlFor="ref_g"className="col-sm-7 col-form-label">Ref_G</label><div className="col-sm-3">
    ...
    value={formik.values.ref_g}></input></div></div>
            ...
            <label htmlFor="max_g"className="col-sm-7 col-form-label">Max_G</label><div className="col-sm-3">
    ...
    value={formik.values.max_g}></input></div></div>
            ...
            <label htmlFor="cr"className="col-sm-7 col-form-label">Cr</label><div className="col-sm-3">
    ...
    value={formik.values.cr}></input></div></div>
            ...
            <label htmlFor="ad"className="col-sm-7 col-form-label">Ad</label><div className="col-sm-3">
    ...
    value={formik.values.ad}></input></div></div>
            ...
            <label htmlFor="aj"className="col-sm-7 col-form-label">Aj</label><div className="col-sm-3">
    ...
    value={formik.values.aj}></input></div></div>
            ...
            <label htmlFor="pb"className="col-sm-7 col-form-label">Pb</label><div className="col-sm-3">
    ...
    value={formik.values.pb}></input></div></div>
            ...
            <label htmlFor="gc"className="col-sm-7 col-form-label">Gc</label><div className="col-sm-3">
    ...
    value={formik.values.gc}></input></div></div>
            ...
            <label htmlFor="tx"className="col-sm-7 col-form-label">Tx</label><div className="col-sm-3">
    ...
    value={formik.values.tx}></input></div></div>
            ...
            <label htmlFor="dtun_nt1_e"className="col-sm-7 col-form-label">Dtun_Nt1_E</label><div className="col-sm-3">
    ...
    value={formik.values.dtun_nt1_e}></input></div></div>
            ...
            <label htmlFor="dtun_nt1_c"className="col-sm-7 col-form-label">Dtun_Nt1_C</label><div className="col-sm-3">
    ...
    value={formik.values.dtun_nt1_c}></input></div></div>
            ...
            <label htmlFor="dtun_nt1_p"className="col-sm-7 col-form-label">Dtun_Nt1_P</label><div className="col-sm-3">
    ...
    value={formik.values.dtun_nt1_p}></input></div></div>
            ...
            <label htmlFor="dtun_nt2"className="col-sm-7 col-form-label">Dtun_Nt2</label><div className="col-sm-3">
    ...
    value={formik.values.dtun_nt2}></input></div></div>
            ...
            <label htmlFor="dtun_nt3"className="col-sm-7 col-form-label">Dtun_Nt3</label><div className="col-sm-3">
    ...
    value={formik.values.dtun_nt3}></input></div></div>
            ...
            <label htmlFor="cdi_100"className="col-sm-7 col-form-label">Cdi_100</label><div className="col-sm-3">
    ...
    value={formik.values.cdi_100}></input></div></div>
            ...
            <label htmlFor="cdi_50"className="col-sm-7 col-form-label">Cdi_50</label><div className="col-sm-3">
    ...
    value={formik.values.cdi_50}></input></div></div>
            ...
            <label htmlFor="cdm"className="col-sm-7 col-form-label">Cdm</label><div className="col-sm-3">
    ...
    value={formik.values.cdm}></input></div></div>
            ...
            <label htmlFor="cd4"className="col-sm-7 col-form-label">Cd4</label><div className="col-sm-3">
    ...
    value={formik.values.cd4}></input></div></div>
            ...
            <label htmlFor="cd3"className="col-sm-7 col-form-label">Cd3</label><div className="col-sm-3">
    ...
    value={formik.values.cd3}></input></div></div>
            ...
            <label htmlFor="cd2"className="col-sm-7 col-form-label">Cd2</label><div className="col-sm-3">
    ...
    value={formik.values.cd2}></input></div></div>
            ...
            <label htmlFor="dnt1"className="col-sm-7 col-form-label">Dnt1</label><div className="col-sm-3">
    ...
    value={formik.values.dnt1}></input></div></div>
            ...
            <label htmlFor="dnt2"className="col-sm-7 col-form-label">Dnt2</label><div className="col-sm-3">
    ...
    value={formik.values.dnt2}></input></div></div>
            ...
            <label htmlFor="dnt3"className="col-sm-7 col-form-label">Dnt3</label><div className="col-sm-3">
    ...
    value={formik.values.dnt3}></input></div></div>
            ...
            <label htmlFor="dnt4"className="col-sm-7 col-form-label">Dnt4</label><div className="col-sm-3">
    ...
    value={formik.values.dnt4}></input></div></div>
            ...
            <label htmlFor="crs"className="col-sm-7 col-form-label">Crs</label><div className="col-sm-3">
    ...
    value={formik.values.crs}></input></div></div>
            ...
            <label htmlFor="rcal"className="col-sm-7 col-form-label">Rcal</label><div className="col-sm-3">
    ...
    value={formik.values.rcal}></input></div></div>
            ...
            <label htmlFor="r"className="col-sm-7 col-form-label">R</label><div className="col-sm-3">
    ...
    value={formik.values.r}></input></div></div>
            ...
            <label htmlFor="iprstn"className="col-sm-7 col-form-label">Iprstn</label><div className="col-sm-3">
    ...
    value={formik.values.iprstn}></input></div></div>
            ...
            <label htmlFor="pr_nt1"className="col-sm-7 col-form-label">Pr_Nt1</label><div className="col-sm-3">
    ...
    value={formik.values.pr_nt1}></input></div></div>
            ...
            <label htmlFor="pr_nt2"className="col-sm-7 col-form-label">Pr_Nt2</label><div className="col-sm-3">
    ...
    value={formik.values.pr_nt2}></input></div></div>
            ...
            <label htmlFor="pr_nt3"className="col-sm-7 col-form-label">Pr_Nt3</label><div className="col-sm-3">
    ...
    value={formik.values.pr_nt3}></input></div></div>
            ...
            <label htmlFor="pr_nt4"className="col-sm-7 col-form-label">Pr_Nt4</label><div className="col-sm-3">
    ...
    value={formik.values.pr_nt4}></input></div></div>
            ...
            <label htmlFor="cer"className="col-sm-7 col-form-label">Cer</label><div className="col-sm-3">
    ...
    value={formik.values.cer}></input></div></div>
            ...
            <label htmlFor="cfm"className="col-sm-7 col-form-label">Cfm</label><div className="col-sm-3">
    ...
    value={formik.values.cfm}></input></div></div>
            ...
            <label htmlFor="rc"className="col-sm-7 col-form-label">Rc</label><div className="col-sm-3">
    ...
    value={formik.values.rc}></input></div></div>
            ...
            <label htmlFor="ul_trim_val_mme"className="col-sm-7 col-form-label">Ul_Trim_Val_Mme</label><div className="col-sm-3">
    ...
    value={formik.values.ul_trim_val_mme}></input></div></div>
            ...
            <label htmlFor="anho_ul_trim_val_mme"className="col-sm-7 col-form-label">Anho_Ul_Trim_Val_Mme</label><div className="col-sm-3">
    ...
    value={formik.values.anho_ul_trim_val_mme}></input></div></div>
            ...
            <label htmlFor="sub1"className="col-sm-7 col-form-label">Sub1</label><div className="col-sm-3">
    ...
    value={formik.values.sub1}></input></div></div>
            ...
            <label htmlFor="sub2"className="col-sm-7 col-form-label">Sub2</label><div className="col-sm-3">
    ...
    value={formik.values.sub2}></input></div></div>
            ...
            <label htmlFor="n_sub1"className="col-sm-7 col-form-label">N_Sub1</label><div className="col-sm-3">
    ...
    value={formik.values.n_sub1}></input></div></div>
            ...
            <label htmlFor="m_sub2"className="col-sm-7 col-form-label">M_Sub2</label><div className="col-sm-3">
    ...
    value={formik.values.m_sub2}></input></div></div>
            ...
            <label htmlFor="facturacion_t"className="col-sm-7 col-form-label">Facturacion_T</label><div className="col-sm-3">
    ...
    value={formik.values.facturacion_t}></input></div></div>
            ...
            <label htmlFor="r1"className="col-sm-7 col-form-label">R1</label><div className="col-sm-3">
    ...
    value={formik.values.r1}></input></div></div>
            ...
            <label htmlFor="r2"className="col-sm-7 col-form-label">R2</label><div className="col-sm-3">
    ...
    value={formik.values.r2}></input></div></div>
            ...
            <label htmlFor="sup_def"className="col-sm-7 col-form-label">Sup_Def</label><div className="col-sm-3">
    ...
    value={formik.values.sup_def}></input></div></div>
            ...
            <label htmlFor="cfs"className="col-sm-7 col-form-label">Cfs</label><div className="col-sm-3">
    ...
    value={formik.values.cfs}></input></div></div>
            ...
            <label htmlFor="cfe"className="col-sm-7 col-form-label">Cfe</label><div className="col-sm-3">
    ...
    value={formik.values.cfe}></input></div></div>
            ...
            <label htmlFor="c_ast"className="col-sm-7 col-form-label">C_Ast</label><div className="col-sm-3">
    ...
    value={formik.values.c_ast}></input></div></div>
            ...
            <label htmlFor="cvr"className="col-sm-7 col-form-label">Cvr</label><div className="col-sm-3">
    ...
    value={formik.values.cvr}></input></div></div>
            ...
            <label htmlFor="cv"className="col-sm-7 col-form-label">Cv</label><div className="col-sm-3">
...
<div className="form-group row">
        <label htmlFor="cu_nt1_100"className="col-sm-7 col-form-label">Cu_Nt1_100</label><div className="col-sm-3">
...
value={formik.values.cu_nt1_100}></input></div></div>
        ...
        <label htmlFor="cu_nt1_50"className="col-sm-7 col-form-label">Cu_Nt1_50</label><div className="col-sm-3">
...
value={formik.values.cu_nt1_50}></input></div></div>
        ...
        <label htmlFor="cu_nt1_0"className="col-sm-7 col-form-label">Cu_Nt1_0</label><div className="col-sm-3">
...
value={formik.values.cu_nt1_0}></input></div></div>
        ...
        <label htmlFor="cu_nt2"className="col-sm-7 col-form-label">Cu_Nt2</label><div className="col-sm-3">
...
value={formik.values.cu_nt2}></input></div></div>
        ...
        <label htmlFor="cu_nt3"className="col-sm-7 col-form-label">Cu_Nt3</label><div className="col-sm-3">
...
value={formik.values.cu_nt3}></input></div></div>
        ...
        <label htmlFor="cu_nt4"className="col-sm-7 col-form-label">Cu_Nt4</label><div className="col-sm-3">
...
value={formik.values.cu_nt4}></input></div></div>
        ...
        <label htmlFor="nt1_100_estrato_1_men_cs"className="col-sm-7 col-form-label">Nt1_100_Estrato_1_Men_Cs</label><div className="col-sm-3">
...
value={formik.values.nt1_100_estrato_1_men_cs}></input></div></div>
        ...
        <label htmlFor="nt1_100_estrato_2_men_cs"className="col-sm-7 col-form-label">Nt1_100_Estrato_2_Men_Cs</label><div className="col-sm-3">
...
value={formik.values.nt1_100_estrato_2_men_cs}></input></div></div>
        ...
        <label htmlFor="nt1_100_estrato_3_men_cs"className="col-sm-7 col-form-label">Nt1_100_Estrato_3_Men_Cs</label><div className="col-sm-3">
...
value={formik.values.nt1_100_estrato_3_men_cs}></input></div></div>
        ...
        <label htmlFor="nt1_100_estrato_4_men_cs"className="col-sm-7 col-form-label">Nt1_100_Estrato_4_Men_Cs</label><div className="col-sm-3">
...
value={formik.values.nt1_100_estrato_4_men_cs}></input></div></div>
        ...
        <label htmlFor="nt1_100_estrato_5_men_cs"className="col-sm-7 col-form-label">Nt1_100_Estrato_5_Men_Cs</label><div className="col-sm-3">
...
value={formik.values.nt1_100_estrato_5_men_cs}></input></div></div>
        ...
        <label htmlFor="nt1_100_estrato_6_men_cs"className="col-sm-7 col-form-label">Nt1_100_Estrato_6_Men_Cs</label><div className="col-sm-3">
...
value={formik.values.nt1_100_estrato_6_men_cs}></input></div></div>
        ...
        <label htmlFor="nt1_100_estrato_4"className="col-sm-7 col-form-label">Nt1_100_Estrato_4</label><div className="col-sm-3">
...
value={formik.values.nt1_100_estrato_4}></input></div></div>
        ...
        <label htmlFor="nt1_100_estrato_5"className="col-sm-7 col-form-label">Nt1_100_Estrato_5</label><div className="col-sm-3">
...
value={formik.values.nt1_100_estrato_5}></input></div></div>
        ...
        <label htmlFor="nt1_100_estrato_6"className="col-sm-7 col-form-label">Nt1_100_Estrato_6</label><div className="col-sm-3">
...
value={formik.values.nt1_100_estrato_6}></input></div></div>
        ...
        <label htmlFor="nt1_100_c"className="col-sm-7 col-form-label">Nt1_100_C</label><div className="col-sm-3">
...
value={formik.values.nt1_100_c}></input></div></div>
        ...
        <label htmlFor="nt1_100_i_con_c"className="col-sm-7 col-form-label">Nt1_100_I_Con_C</label><div className="col-sm-3">
...
value={formik.values.nt1_100_i_con_c}></input></div></div>
        ...
        <label htmlFor="nt1_100_i_sin_c"className="col-sm-7 col-form-label">Nt1_100_I_Sin_C</label><div className="col-sm-3">
...
value={formik.values.nt1_100_i_sin_c}></input></div></div>
        ...
        <label htmlFor="nt1_100_p"className="col-sm-7 col-form-label">Nt1_100_P</label><div className="col-sm-3">
...
value={formik.values.nt1_100_p}></input></div></div>
        ...
        <label htmlFor="nt1_100_o"className="col-sm-7 col-form-label">Nt1_100_O</label><div className="col-sm-3">
...
value={formik.values.nt1_100_o}></input></div></div>
        ...
        <label htmlFor="nt1_50_100_estrato_1_men_cs"className="col-sm-7 col-form-label">Nt1_50_100_Estrato_1_Men_Cs</label><div className="col-sm-3">
        <input type="number" className="form-control" id="nt1_50_100_estrato_1_men_cs" placeholder="Nt1_50_100_Estrato_1_Men_Cs"
onChange={formik.handleChange}
onBlur={formik.handleBlur}
value={formik.values.nt1_50_100_estrato_1_men_cs}></input></div></div>
        { formik.touched.nt1_50_100_estrato_1_men_cs&& formik.errors.nt1_50_100_estrato_1_men_cs? (
        <div className="my-2 bg-red-100 border-l-4 border-red-500 text-red-700 p-4" >
        <p className="font-bold">Error</p>
        <p>{formik.errors.nt1_50_100_estrato_1_men_cs}</p>
        </div>
        ) : null  }<div className="form-group row">
        <label htmlFor="nt1_50_100_estrato_2_men_cs"className="col-sm-7 col-form-label">Nt1_50_100_Estrato_2_Men_Cs</label><div className="col-sm-3">
        <input type="number" className="form-control" id="nt1_50_100_estrato_2_men_cs" placeholder="Nt1_50_100_Estrato_2_Men_Cs"
onChange={formik.handleChange}
onBlur={formik.handleBlur}
value={formik.values.nt1_50_100_estrato_2_men_cs}></input></div></div>
        { formik.touched.nt1_50_100_estrato_2_men_cs&& formik.errors.nt1_50_100_estrato_2_men_cs? (
        <div className="my-2 bg-red-100 border-l-4 border-red-500 text-red-700 p-4" >
        <p className="font-bold">Error</p>
        <p>{formik.errors.nt1_50_100_estrato_2_men_cs}</p>
        </div>
        ) : null  }<div className="form-group row">
        <label htmlFor="nt1_50_100_estrato_3_men_cs"className="col-sm-7 col-form-label">Nt1_50_100_Estrato_3_Men_Cs</label><div className="col-sm-3">
        <input type="number" className="form-control" id="nt1_50_100_estrato_3_men_cs" placeholder="Nt1_50_100_Estrato_3_Men_Cs"
onChange={formik.handleChange}
onBlur={formik.handleBlur}
value={formik.values.nt1_50_100_estrato_3_men_cs}></input></div></div>
        { formik.touched.nt1_50_100_estrato_3_men_cs&& formik.errors.nt1_50_100_estrato_3_men_cs? (
        <div className="my-2 bg-red-100 border-l-4 border-red-500 text-red-700 p-4" >
        <p className="font-bold">Error</p>
        <p>{formik.errors.nt1_50_100_estrato_3_men_cs}</p>
        </div>
        ) : null  }<div className="form-group row">
        <label htmlFor="nt1_50_100_estrato_4_men_cs"className="col-sm-7 col-form-label">Nt1_50_100_Estrato_4_Men_Cs</label><div className="col-sm-3">
        <input type="number" className="form-control" id="nt1_50_100_estrato_4_men_cs" placeholder="Nt1_50_100_Estrato_4_Men_Cs"
onChange={formik.handleChange}
onBlur={formik.handleBlur}
value={formik.values.nt1_50_100_estrato_4_men_cs}></input></div></div>
        { formik.touched.nt1_50_100_estrato_4_men_cs&& formik.errors.nt1_50_100_estrato_4_men_cs? (
        <div className="my-2 bg-red-100 border-l-4 border-red-500 text-red-700 p-4" >
        <p className="font-bold">Error</p>
        <p>{formik.errors.nt1_50_100_estrato_4_men_cs}</p>
        </div>
        ) : null  }<div className="form-group row">
        <label htmlFor="nt1_50_100_estrato_5_men_cs"className="col-sm-7 col-form-label">Nt1_50_100_Estrato_5_Men_Cs</label><div className="col-sm-3">
        <input type="number" className="form-control" id="nt1_50_100_estrato_5_men_cs" placeholder="Nt1_50_100_Estrato_5_Men_Cs"
onChange={formik.handleChange}
onBlur={formik.handleBlur}
value={formik.values.nt1_50_100_estrato_5_men_cs}></input></div></div>
        { formik.touched.nt1_50_100_estrato_5_men_cs&& formik.errors.nt1_50_100_estrato_5_men_cs? (
        <div className="my-2 bg-red-100 border-l-4 border-red-500 text-red-700 p-4" >
        <p className="font-bold">Error</p>
        <p>{formik.errors.nt1_50_100_estrato_5_men_cs}</p>
        </div>
        ) : null  }<div className="form-group row">
        <label htmlFor="nt1_50_100_estrato_6_men_cs"className="col-sm-7 col-form-label">Nt1_50_100_Estrato_6_Men_Cs</label><div className="col-sm-3">
        <input type="number" className="form-control" id="nt1_50_100_estrato_6_men_cs" placeholder="Nt1_50_100_Estrato_6_Men_Cs"
onChange={formik.handleChange}
onBlur={formik.handleBlur}
value={formik.values.nt1_50_100_estrato_6_men_cs}></input></div></div>
        { formik.touched.nt1_50_100_estrato_6_men_cs&& formik.errors.nt1_50_100_estrato_6_men_cs? (
        <div className="my-2 bg-red-100 border-l-4 border-red-500 text-red-700 p-4" >
        <p className="font-bold">Error</p>
        <p>{formik.errors.nt1_50_100_estrato_6_men_cs}</p>
        </div>
        ) : null  }<div className="form-group row">
        <label htmlFor="nt1_50_100_estrato_4"className="col-sm-7 col-form-label">Nt1_50_100_Estrato_4</label><div className="col-sm-3">
        <input type="number" className="form-control" id="nt1_50_100_estrato_4" placeholder="Nt1_50_100_Estrato_4"
onChange={formik.handleChange}
onBlur={formik.handleBlur}
value={formik.values.nt1_50_100_estrato_4}></input></div></div>
        { formik.touched.nt1_50_100_estrato_4&& formik.errors.nt1_50_100_estrato_4? (
        <div className="my-2 bg-red-100 border-l-4 border-red-500 text-red-700 p-4" >
        <p className="font-bold">Error</p>
        <p>{formik.errors.nt1_50_100_estrato_4}</p>
        </div>
        ) : null  }<div className="form-group row">
        <label htmlFor="nt1_50_100_estrato_5"className="col-sm-7 col-form-label">Nt1_50_100_Estrato_5</label><div className="col-sm-3">
        <input type="number" className="form-control" id="nt1_50_100_estrato_5" placeholder="Nt1_50_100_Estrato_5"
onChange={formik.handleChange}
onBlur={formik.handleBlur}
value={formik.values.nt1_50_100_estrato_5}></input></div></div>
        { formik.touched.nt1_50_100_estrato_5&& formik.errors.nt1_50_100_estrato_5? (
        <div className="my-2 bg-red-100 border-l-4 border-red-500 text-red-700 p-4" >
        <p className="font-bold">Error</p>
        <p>{formik.errors.nt1_50_100_estrato_5}</p>
        </div>
        ) : null  }<div className="form-group row">
        <label htmlFor="nt1_50_100_estrato_6"className="col-sm-7 col-form-label">Nt1_50_100_Estrato_6</label><div className="col-sm-3">
        <input type="number" className="form-control" id="nt1_50_100_estrato_6" placeholder="Nt1_50_100_Estrato_6"
onChange={formik.handleChange}
onBlur={formik.handleBlur}
value={formik.values.nt1_50_100_estrato_6}></input></div></div>
        { formik.touched.nt1_50_100_estrato_6&& formik.errors.nt1_50_100_estrato_6? (
        <div className="my-2 bg-red-100 border-l-4 border-red-500 text-red-700 p-4" >
        <p className="font-bold">Error</p>
        <p>{formik.errors.nt1_50_100_estrato_6}</p>
        </div>
        ) : null  }<div className="form-group row">
        <label htmlFor="nt1_50_100_c"className="col-sm-7 col-form-label">Nt1_50_100_C</label><div className="col-sm-3">
        <input type="number" className="form-control" id="nt1_50_100_c" placeholder="Nt1_50_100_C"
onChange={formik.handleChange}
onBlur={formik.handleBlur}
value={formik.values.nt1_50_100_c}></input></div></div>
        { formik.touched.nt1_50_100_c&& formik.errors.nt1_50_100_c? (
        <div className="my-2 bg-red-100 border-l-4 border-red-500 text-red-700 p-4" >
        <p className="font-bold">Error</p>
        <p>{formik.errors.nt1_50_100_c}</p>
        </div>
        ) : null  }<div className="form-group row">
        <label htmlFor="nt1_50_100_i_con_c"className="col-sm-7 col-form-label">Nt1_50_100_I_Con_C</label><div className="col-sm-3">
        <input type="number" className="form-control" id="nt1_50_100_i_con_c" placeholder="Nt1_50_100_I_Con_C"
onChange={formik.handleChange}
onBlur={formik.handleBlur}
value={formik.values.nt1_50_100_i_con_c}></input></div></div>
        { formik.touched.nt1_50_100_i_con_c&& formik.errors.nt1_50_100_i_con_c? (
        <div className="my-2 bg-red-100 border-l-4 border-red-500 text-red-700 p-4" >
        <p className="font-bold">Error</p>
        <p>{formik.errors.nt1_50_100_i_con_c}</p>
        </div>
        ) : null  }<div className="form-group row">
        <label htmlFor="nt1_50_100_i_sin_c"className="col-sm-7 col-form-label">Nt1_50_100_I_Sin_C</label><div className="col-sm-3">
        <input type="number" className="form-control" id="nt1_50_100_i_sin_c" placeholder="Nt1_50_100_I_Sin_C"
onChange={formik.handleChange}
onBlur={formik.handleBlur}
value={formik.values.nt1_50_100_i_sin_c}></input></div></div>
        { formik.touched.nt1_50_100_i_sin_c&& formik.errors.nt1_50_100_i_sin_c? (
        <div className="my-2 bg-red-100 border-l-4 border-red-500 text-red-700 p-4" >
        <p className="font-bold">Error</p>
        <p>{formik.errors.nt1_50_100_i_sin_c}</p>
        </div>
        ) : null  }<div className="form-group row">
        <label htmlFor="nt1_50_100_p"className="col-sm-7 col-form-label">Nt1_50_100_P</label><div className="col-sm-3">
        <input type="number" className="form-control" id="nt1_50_100_p" placeholder="Nt1_50_100_P"
onChange={formik.handleChange}
onBlur={formik.handleBlur}
value={formik.values.nt1_50_100_p}></input></div></div>
        { formik.touched.nt1_50_100_p&& formik.errors.nt1_50_100_p? (
        <div className="my-2 bg-red-100 border-l-4 border-red-500 text-red-700 p-4" >
        <p className="font-bold">Error</p>
        <p>{formik.errors.nt1_50_100_p}</p>
        </div>
        ) : null  }<div className="form-group row">
        <label htmlFor="nt1_50_100_o"className="col-sm-7 col-form-label">Nt1_50_100_O</label><div className="col-sm-3">
        <input type="number" className="form-control" id="nt1_50_100_o" placeholder="Nt1_50_100_O"
onChange={formik.handleChange}
onBlur={formik.handleBlur}
value={formik.values.nt1_50_100_o}></input></div></div>
        { formik.touched.nt1_50_100_o&& formik.errors.nt1_50_100_o? (
        <div className="my-2 bg-red-100 border-l-4 border-red-500 text-red-700 p-4" >
        <p className="font-bold">Error</p>
        <p>{formik.errors.nt1_50_100_o}</p>
        </div>
        ) : null  }<div className="form-group row">
        <label htmlFor="nt1_0_estrato_1_men_cs"className="col-sm-7 col-form-label">Nt1_0_Estrato_1_Men_Cs</label><div className="col-sm-3">
...
value={formik.values.nt1_0_estrato_1_men_cs}></input></div></div>
        ...
        <label htmlFor="nt1_0_estrato_2_men_cs"className="col-sm-7 col-form-label">Nt1_0_Estrato_2_Men_Cs</label><div className="col-sm-3">
...
value={formik.values.nt1_0_estrato_2_men_cs}></input></div></div>
        ...
        <label htmlFor="nt1_0_estrato_3_men_cs"className="col-sm-7 col-form-label">Nt1_0_Estrato_3_Men_Cs</label><div className="col-sm-3">
...
value={formik.values.nt1_0_estrato_3_men_cs}></input></div></div>
        ...
        <label htmlFor="nt1_0_estrato_4_men_cs"className="col-sm-7 col-form-label">Nt1_0_Estrato_4_Men_Cs</label><div className="col-sm-3">
...
value={formik.values.nt1_0_estrato_4_men_cs}></input></div></div>
        ...
        <label htmlFor="nt1_0_estrato_5_men_cs"className="col-sm-7 col-form-label">Nt1_0_Estrato_5_Men_Cs</label><div className="col-sm-3">
...
value={formik.values.nt1_0_estrato_5_men_cs}></input></div></div>
        ...
        <label htmlFor="nt1_0_estrato_6_men_cs"className="col-sm-7 col-form-label">Nt1_0_Estrato_6_Men_Cs</label><div className="col-sm-3">
...
value={formik.values.nt1_0_estrato_6_men_cs}></input></div></div>
        ...
        <label htmlFor="nt1_0_estrato_4"className="col-sm-7 col-form-label">Nt1_0_Estrato_4</label><div className="col-sm-3">
...
value={formik.values.nt1_0_estrato_4}></input></div></div>
        ...
        <label htmlFor="nt1_0_estrato_5"className="col-sm-7 col-form-label">Nt1_0_Estrato_5</label><div className="col-sm-3">
...
value={formik.values.nt1_0_estrato_5}></input></div></div>
        ...
        <label htmlFor="nt1_0_estrato_6"className="col-sm-7 col-form-label">Nt1_0_Estrato_6</label><div className="col-sm-3">
...
value={formik.values.nt1_0_estrato_6}></input></div></div>
        ...
        <label htmlFor="nt1_0_c"className="col-sm-7 col-form-label">Nt1_0_C</label><div className="col-sm-3">
...
value={formik.values.nt1_0_c}></input></div></div>
        ...
        <label htmlFor="nt1_0_i_con_c"className="col-sm-7 col-form-label">Nt1_0_I_Con_C</label><div className="col-sm-3">
...
value={formik.values.nt1_0_i_con_c}></input></div></div>
        ...
        <label htmlFor="nt1_0_i_sin_c"className="col-sm-7 col-form-label">Nt1_0_I_Sin_C</label><div className="col-sm-3">
...
value={formik.values.nt1_0_i_sin_c}></input></div></div>
        ...
        <label htmlFor="nt1_0_p"className="col-sm-7 col-form-label">Nt1_0_P</label><div className="col-sm-3">
...
value={formik.values.nt1_0_p}></input></div></div>
        ...
        <label htmlFor="nt1_0_o"className="col-sm-7 col-form-label">Nt1_0_O</label><div className="col-sm-3">
...
value={formik.values.nt1_0_o}></input></div></div>
        ...
        <label htmlFor="nt2_c"className="col-sm-7 col-form-label">Nt2_C</label><div className="col-sm-3">
...
value={formik.values.nt2_c}></input></div></div>
        ...
        <label htmlFor="nt2_i_con_c"className="col-sm-7 col-form-label">Nt2_I_Con_C</label><div className="col-sm-3">
...
value={formik.values.nt2_i_con_c}></input></div></div>
        ...
        <label htmlFor="nt2_i_sin_c"className="col-sm-7 col-form-label">Nt2_I_Sin_C</label><div className="col-sm-3">
...
value={formik.values.nt2_i_sin_c}></input></div></div>
        ...
        <label htmlFor="nt2_o"className="col-sm-7 col-form-label">Nt2_O</label><div className="col-sm-3">
...
value={formik.values.nt2_o}></input></div></div>
        ...
        <label htmlFor="nt2_ap"className="col-sm-7 col-form-label">Nt2_Ap</label><div className="col-sm-3">
...
value={formik.values.nt2_ap}></input></div></div>
        ...
        <label htmlFor="nt2_bsnmen_cs"className="col-sm-7 col-form-label">Nt2_Bsnmen_Cs</label><div className="col-sm-3">
...
value={formik.values.nt2_bsnmen_cs}></input></div></div>
        ...
        <label htmlFor="nt2_bsnmay_cs"className="col-sm-7 col-form-label">Nt2_Bsnmay_Cs</label><div className="col-sm-3">
...
value={formik.values.nt2_bsnmay_cs}></input></div></div>
        ...
        <label htmlFor="nt3_c"className="col-sm-7 col-form-label">Nt3_C</label><div className="col-sm-3">
...
value={formik.values.nt3_c}></input></div></div>
        ...
        <label htmlFor="nt3_i_con_c"className="col-sm-7 col-form-label">Nt3_I_Con_C</label><div className="col-sm-3">
...
value={formik.values.nt3_i_con_c}></input></div></div>
        ...
        <label htmlFor="nt3_i_sin_c"className="col-sm-7 col-form-label">Nt3_I_Sin_C</label><div className="col-sm-3">
...
value={formik.values.nt3_i_sin_c}></input></div></div>
        ...
        <label htmlFor="nt3_o"className="col-sm-7 col-form-label">Nt3_O</label><div className="col-sm-3">
...
value={formik.values.nt3_o}></input></div></div>
        ...
        <label htmlFor="nt3_ap"className="col-sm-7 col-form-label">Nt3_Ap</label><div className="col-sm-3">
