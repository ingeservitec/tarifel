...
pui_cop_kwh:{type: DataTypes.FLOAT,allowNull: false,trim: true},
...
g_exc1:{type: DataTypes.FLOAT,allowNull: false,trim: true},
g_exc1_21:{type: DataTypes.FLOAT,allowNull: false,trim: true},
g_exc2:{type: DataTypes.FLOAT,allowNull: false,trim: true},
g_exc3:{type: DataTypes.FLOAT,allowNull: false,trim: true},
ggd:{type: DataTypes.FLOAT,allowNull: false,trim: true},
})
