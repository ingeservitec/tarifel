...
value={formik.values.mes}></input></div></div>
        ...
        <label htmlFor="area"className="col-sm-7 col-form-label">Area</label><div className="col-sm-3">
...
value={formik.values.area}></input></div></div>
        ...
        <label htmlFor="nivel_tension"className="col-sm-7 col-form-label">Nivel_Tension</label><div className="col-sm-3">
...
value={formik.values.valor}></input></div></div>
        ...
        <label htmlFor="operador_red"className="col-sm-7 col-form-label">Operador_Red</label><div className="col-sm-3">
...
value={formik.values.operador_red}></input></div></div>
        ...
        <div className="form-group row">
        <label htmlFor="version"className="col-sm-7 col-form-label">Versión</label><div className="col-sm-3">
